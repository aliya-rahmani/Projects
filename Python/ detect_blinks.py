...
# then a second constant for the number of consecutive frames the eye must be
# below the threshold
EYE_AR_THRESH = 0.3
...
while True:
    ...
    for rect in rects:
        ...
        # extract the left and right eye coordinates, then use
        # the coordinates to compute the eye aspect ratio for
        # both eyes
